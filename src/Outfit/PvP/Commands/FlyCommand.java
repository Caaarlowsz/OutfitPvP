	...
	public boolean onCommand(CommandSender s, Command cmd, String label, String[] args) {
		if (!(s instanceof Player)) {
			...
			if (!p.hasPermission("zey.pvp.fly")) {
				p.sendMessage(
						OutfitPvP.prefix + " §8➸ §cVocê precisa ser §1§lBETA §cou superior, para voar.");
				return true;
				...
				if (p.getAllowFlight()) {
					...
					p.setFlying(true);
					p.sendMessage(OutfitPvP.prefix + " §8➸ §7Modo Fly §a§lHABILITADO §7para o jogador(a): §e"
							+ p.getName());
					return true;
				}
				...
				if (t == null) {
					p.sendMessage(OutfitPvP.prefix + " §8➸ §cEste jogador(a) está offline.");
					return true;
					...
					t.sendMessage(OutfitPvP.prefix + " §8➸ §7Fly §c§lDESABILITADO §7pelo jogador(a): §e"
							+ p.getName());
					return true;
				} else {
					...
					t.sendMessage(OutfitPvP.prefix + " §8➸ §7Fly §a§lHABILITADO §7pelo jogador(a): §e"
							+ p.getName());
					return true;
				}
			}
