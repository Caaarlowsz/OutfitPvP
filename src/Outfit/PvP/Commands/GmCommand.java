         ...
         if (args.length == 0) {
            ...
            if (!p.hasPermission("zey.pvp.gm") && !p.isOp()) {
               ...
               if (!args[0].equalsIgnoreCase("0") && !args[0].equalsIgnoreCase("sobrevivencia")) {
                  ...
                  p.sendMessage(String.valueOf(Main.prefix) + " §8➸ §7Seu gamemode foi alterado para §c§lSOBREVIVENCIA§7.");
               }
            } else {
               p.setGameMode(GameMode.CREATIVE);
               p.sendMessage(String.valueOf(Main.prefix) + " §8➸ §7Seu gamemode foi alterado para §a§lCRIATIVO§7.");
            }
         }
      }
