...
public class IniciarCommand implements CommandExecutor {
   ...
   public boolean onCommand(CommandSender sender, Command cmd, String lbl, String[] args) {
      ...
      if (cmd.getName().equalsIgnoreCase("iniciar")) {
         ...
         if (args.length == 0) {
            p.sendMessage(String.valueOf(Main.prefix) + " §8➸ §cErrado, utilize a sintaxe correta: /iniciar [Evento] [FullKit]");
            return true;
         }
         ...
         if (args[0].equalsIgnoreCase("evento")) {
            ...
            Bukkit.broadcastMessage(String.valueOf(Main.prefix) + " §8➸ §aUm Evento foi iniciado, para entrar use o comando /evento§a.");
            evento = true;
            return true;
         }
         ...
         if (args[0].equalsIgnoreCase("fullkit")) {
            ...
            Bukkit.broadcastMessage(String.valueOf(Main.prefix) + " §8➸ §aO beneficio FullKit está liberado para todos, aproveitem.");
            fullkit = true;
            return true;
         }
