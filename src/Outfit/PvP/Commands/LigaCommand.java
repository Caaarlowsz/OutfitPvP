...
public class LigaCommand implements CommandExecutor {
   ...
   public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
      ...
      if (cmd.getName().equalsIgnoreCase("liga") && args.length == 0) {
         p.sendMessage(" ");
         p.sendMessage(String.valueOf(Main.prefix) + " §8➸ §fAqui estão há lista de todas as Ligas/Ranks, do servidor:");
         p.sendMessage("                              ");
         ...
         p.sendMessage("                              ");
         p.sendMessage(String.valueOf(Main.prefix) + " §8➸ §fVocê pode adquirir estas Ligas/Ranks, matando jogadores. Apos matar os jogadores você ganhara kills, e com essas kills você ira upar! Boa sorte.");
         p.sendMessage(" ");
      }
