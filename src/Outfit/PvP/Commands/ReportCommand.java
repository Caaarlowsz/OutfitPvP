         ...
         if (commandLabel.equalsIgnoreCase("report")) {
            if (args.length >= 2) {
               ...
               if (target != null) {
                  ...
                  p.sendMessage(String.valueOf(Main.prefix) + " §8➸ §7O Report do jogador §e" + target.getName() + " §7pelo motivo §c" + reportMsg + "§7 foi enviado a nossa equipe!");
               ...
               p.sendMessage(String.valueOf(Main.prefix) + " §8➸ §cErrado, utilize a sintaxe correta: /report [Jogador(a)] (motivo)");
            }
         }
