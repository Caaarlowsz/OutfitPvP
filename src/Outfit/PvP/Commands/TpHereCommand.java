...
public class TpHereCommand implements CommandExecutor {
   public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
      ...
      if (!cmd.getName().equalsIgnoreCase("tphere") && !cmd.getName().equalsIgnoreCase("here")) {
         ...
         p.sendMessage(String.valueOf(Main.prefix) + " §8➸ §cErrado, utilize a sintaxe correta: /tphere ou /here para puxar um jogador até você.");
         return true;
      } else {
         ...
         if (k == null) {
            ...
            k.teleport(p);
            p.sendMessage(String.valueOf(Main.prefix) + " §8➸ §7Você puxou o jogador: §e" + k.getName() + " §7até você.");
            return true;
         }
      }
   }
