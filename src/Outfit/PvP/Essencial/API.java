...
public class API
{
    ...
    public static void AutomaticMessage() {
		...
		case 1:
			...
			Bukkit.broadcastMessage(String.valueOf(Main.prefix) + " §8➸ §7O servidor está em fase §d§lBETA§7. Caso você encontre algum §d§lERRO§7, reporte em nosso Discord!");
			Bukkit.broadcastMessage(" ");
			break;
		case 2:
			Bukkit.broadcastMessage(" ");
			Bukkit.broadcastMessage(String.valueOf(Main.prefix) + " §8➸ §7Para fazer uma denúncia, use: §d/report (nick) (motivo)§7.");
			Bukkit.broadcastMessage(" ");
			break;
		case 3:
			Bukkit.broadcastMessage(" ");
			Bukkit.broadcastMessage(String.valueOf(Main.prefix) + " §8➸ §7Entre no nosso §d§lDISCORD §7e fique por dentro de nossas novidades! §8[§dhttps://discord.gg/FDFhphW]");
			Bukkit.broadcastMessage(" ");
			break;
		case 4:
			Bukkit.broadcastMessage(" ");
			Bukkit.broadcastMessage(String.valueOf(Main.prefix) + " §8➸ §7Deseja tag §b§lYT §7digite §d/youtuber §7para saber os requisitos.");
			Bukkit.broadcastMessage(" ");
			break;
		case 5:
			Bukkit.broadcastMessage(" ");
			Bukkit.broadcastMessage(String.valueOf(Main.prefix) + " §8➸ §7Há algum interesse em integrar à nossa §d§lSTAFF§7, §7utilize §d/aplicar§7.");
			Bukkit.broadcastMessage(" ");
			break;
		case 6:
			Bukkit.broadcastMessage(" ");
			Bukkit.broadcastMessage(String.valueOf(Main.prefix) + " §8➸ §7Fique atento as §d§lREGRAS§7 e evite ser banido do servidor, §7utilize §d/regras§7.");
			Bukkit.broadcastMessage(" ");
			break;	
		case 7:
			Bukkit.broadcastMessage(" ");
			Bukkit.broadcastMessage(String.valueOf(Main.prefix) + " §8➸ §7Quer saber seu status? use o comando §d/status §7para saber seu status!");
			Bukkit.broadcastMessage(" ");
			break;
		case 8:
			Bukkit.broadcastMessage(" ");
