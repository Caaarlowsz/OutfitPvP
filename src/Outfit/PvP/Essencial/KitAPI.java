...
public class KitAPI implements Listener {
	...
	public static ArrayList<String> Alladin;
	...
	public static ArrayList<String> MiniGun;
	...
	static {
		...
		KitAPI.MiniGun = new ArrayList<String>();
	...
	public static void recraft(final Player p) {
		...
		kespada1.setDisplayName("§dBussula");
	...
	public static void swordkitpvp(final Player p) {
		...
		itemmeta.setDisplayName("§dEspada");
	...
	public static void sword(final Player p) {
		...
		kespada.setDisplayName("§dEspada");
