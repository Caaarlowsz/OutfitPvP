...
public class CombatLog implements Listener {
      ...
      if (!e.isCancelled()) {
         if (e.getDamager() instanceof Player && e.getEntity() instanceof Player) {
            ...
            if (!Sair.contains(p.getName()) && !Sair.contains(hitter.getName())) {
               ...
               p.sendMessage(String.valueOf(Main.prefix) + " §8➸ §7Voce entrou em combate com §d" + hitter.getName());
               hitter.sendMessage(String.valueOf(Main.prefix) + " §8➸ §7Voce entrou em combate com §d" + p.getName());
   ...
   public void onPlayerExit(PlayerQuitEvent e) throws SQLException {
      ...
      if (Sair.contains(p.getName())) {
         ...
         Bukkit.broadcastMessage(String.valueOf(Main.prefix) + " §8➸ §d" + p.getName() + " §7foi cagar em combate e perdeu §d100 §7Dolls§7!");
